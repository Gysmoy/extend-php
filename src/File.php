...
class File
{
    ...
    public static function getExtention(string $mimetype): string
    {
        ...
        $vals = array_values(File::$pairs);

        $position = array_search($mimetype, $vals);
        if ($position !== false) {
            $extention = $keys[$position];
        }
    ...
    public static function getMimeType(string $extention): string
    {
        ...
        $position = array_search($extention, $keys);
        if ($position !== false) {
            $mimetype = $vals[$position];
        }
